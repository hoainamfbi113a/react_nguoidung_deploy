  ...
  render() {
    return (
      ...
      <aside className="aside1">
        {/* <div class="cac-slide">
                  <div class="slide active"><img src="../img/images/slide1.jpg" alt=""></div>
                  <div class="slide"><img src="../img/images/slide2.jpg" alt=""></div>
                  <div class="slide"><img src="../img/images/slide3.jpg" alt=""></div>
                  <div class="slide"><img src="../img/slide1.png" alt=""></div>
              </div> */}
          ...
          <div className="js-carouselCtx Carousel-content">
            <div className="js-carouselList Carousel-content-list">
              <div className="Carousel-content-item" id="carousel1">
                <img src="../img/images/slide1.jpg" alt="" />
              </div>
        ...
        {/* <div class="nut-slide">
                      <span id="btn-prev"><i class="fa fa-chevron-left"></i></span>
                      <span id="btn-next"><i class="fa fa-chevron-right"></i></span>
                      <ul>
                         <li class="active1"><a>Cùng đại gia đình Shin<br> Đến NLKid học thôi nào</a></li>
                         <li> <a>Cùng đại gia đình Shin<br> Đến NLKid học thôi nào</a></li>
                         <li ><a>Cùng đại gia đình Shin<br> Đến NLKid học thôi nào</a></li>
                         <li ><a>Cùng đại gia đình Shin<br> Đến NLKid học thôi nào</a></li>
      ...
      <div className="inf-class">
        <a href><img src="../img/images/lop1.jpg" alt="lop 1" /></a>
        <a href><img src="../img/images/lop2.jpg" alt="lop 2" /></a>
        <a href><img src="../img/images/lop3.jpg" alt="lop 3" /></a>
        <a href><img src="../img/images/lop4.jpg" alt="lop 4" /></a>
        <a href><img src="../img/images/lop5.jpg" alt="lop 5" /></a>
      </div>
      <div className="top-user">
        ...
        <div className="d-flex">
          <h3 style={{width: '22px'}}>1</h3>
          <div className>
            <img alt="Hứa Hoàng Danh" src="https://api.adorable.io/avatars/55/Hứa Hoàng Danh" />
          </div>
          <h4 className="nameusertop">NGUYỄN HOÀI NAM</h4>
          <h4 className="ml-auto">9999</h4>
        </div>
        <div className="d-flex">
        ...
        <div className="khoi-product-new">
          <div className="productnew active_product">
            <div className="boxProduct">
              <img src="../img/images/carousel1.jpg" alt="" />
              <h3>Tiêu đề</h3>
          ...
          <div className="productnew  ">
            <div className="boxProduct">
              <img src="../img/images/carousel2.jpg" alt="" />
              <h3>Tiêu đề</h3>
              <div className="destation">
                Nội dung của bài học xxxxxxxxxxx
              </div>
